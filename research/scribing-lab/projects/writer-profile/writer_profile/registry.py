    ...
    (
        ...
        (
            ...
            WriterProfile(
                ...
                params=WriterProfileParameters(
                    slant_deg=1.85,
                    spacing_mean_mm=1.15,
                    speed_mean_mm_s=41.1,
                    harai_gain=1.01,
                    hane_gain=1.0,
                    tome_gain=0.99,
                    timing_jitter_cv=0.08,
                    tremor_mm=0.015,
                    baseline_drift_mm=0.02,
                    shape_variation=0.004,
                    layout_variation=0.002,
                ),
                parent_profile="kana-neat",
                notes="Latin-oriented neat profile for ASCII, digits, and punctuation comparisons.",
            ),
        ),
        (
            "symbol-neat",
            WriterProfile(
                ...
                params=WriterProfileParameters(
                    slant_deg=1.9,
                    spacing_mean_mm=1.14,
                    speed_mean_mm_s=40.8,
                    harai_gain=1.0,
                    hane_gain=1.0,
                    tome_gain=0.99,
                    timing_jitter_cv=0.0,
                    tremor_mm=0.0,
                    baseline_drift_mm=0.005,
                    shape_variation=0.002,
                    layout_variation=0.001,
                ),
                parent_profile="latin-neat",
                notes="Symbol-oriented neat profile for punctuation and bracket-heavy comparisons.",
            ),
        ),
        (
            "kanji-neat",
            WriterProfile(
                ...
                params=WriterProfileParameters(
                    ...
                    tremor_mm=0.0165,
                    baseline_drift_mm=0.04,
                    shape_variation=0.006,
                    layout_variation=0.003,
                ),
                parent_profile="baseline-neat",
                notes="Kanji-oriented neat profile for short kanji text and symbol-adjacent comparisons.",
            ),
        ),
        (
            "kanji-tight",
            WriterProfile(
                ...
                params=WriterProfileParameters(
                    ...
                    speed_mean_mm_s=39.8,
                    harai_gain=1.005,
                    hane_gain=1.0,
                    tome_gain=0.995,
                    timing_jitter_cv=0.03,
                    tremor_mm=0.009,
                    baseline_drift_mm=0.012,
                    shape_variation=0.0035,
                    layout_variation=0.002,
                ),
                parent_profile="kanji-neat",
                notes="Tighter kanji profile for short kanji phrases and spacing-sensitive comparisons.",
            ),
        ),
        (
            "steady-neat",
